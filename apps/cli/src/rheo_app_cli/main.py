...
from rheo_app_cli.commands import account, doctor, member, migrate, routing, workspace
...
def build_parser() -> argparse.ArgumentParser:
    ...
    for module in (migrate, account, workspace, doctor, routing, member):
