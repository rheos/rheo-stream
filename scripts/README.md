...
The check verifies that private runtime paths are ignored, public source/example
paths remain trackable, no ignored artifacts are already tracked, and local inline
